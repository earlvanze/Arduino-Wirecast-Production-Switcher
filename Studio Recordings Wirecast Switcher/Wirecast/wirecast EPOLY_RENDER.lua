...
lmc_add_com('ARDUINO', 'COM3', 9600, 8, 'N', 1)
...
-- Numpad7 to 7 - NumLock ON
lmc_set_handler('NUMPAD',103,1,function(button, direction)
  lmc_send_keys('7')
end)
-- Numpad7 to 7 - NumLock OFF
lmc_set_handler('NUMPAD',36,1,function(button, direction)
  lmc_send_keys('7')
end)

-- Numpad8 to 8 - NumLock ON
lmc_set_handler('NUMPAD',104,1,function(button, direction)
  lmc_send_keys('8')
end)
-- Numpad8 to 8 - NumLock OFF
lmc_set_handler('NUMPAD',38,1,function(button, direction)
  lmc_send_keys('8')
end)

-- Numpad9 to 9 - NumLock ON
lmc_set_handler('NUMPAD',105,1,function(button, direction)
  lmc_send_keys('9')
end)
-- Numpad9 to 9 - NumLock OFF
lmc_set_handler('NUMPAD',33,1,function(button, direction)
  lmc_send_keys('9')
end)
